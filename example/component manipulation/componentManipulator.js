(function () {
    var ANumber = React.createClass({displayName: 'ANumber',
        ...
        setValue: function (newValue) {
            this.props.object.set(this.props.name, newValue);
    ...
    var AString = React.createClass({displayName: 'AString',
        ...
        setValue: function (value) {
            this.props.object.set(this.props.name, value);
    ...
    var ManipulatableComponent = React.createClass({displayName: "ManipulatableComponent",
        componentWillMount: function () {
            ...
            // setState
            //
            // Then we have set, set is used in the react bool number and string components to send the value to the client
            ...
            this.props.component.state.update = function (key, newValue) {
                stateListeners.forEach(function (l) {
                    l(key, newValue);
                });
            };

            this.props.component.props.update = function (key, newValue) {
    ...
    window.makeManipulator = makeManipulator
}());
